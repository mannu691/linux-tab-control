module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener` yessawl-as-d s tiɣiret n tidet tis kuẓ." ],
      ...
      "Placeholder for message is missing":[ "Amḍiq yettwaḥ€rzen i yizen ulac-it" ],
      "A placeholder used in the message is not defined.":[ "Amḍiq yettwaḥ€rzen yettwasqedcen deg izen ur yettwasbadu ara." ],
      "Placeholder name contains invalid characters":[ "Amḍiq yettwaḥ€rzen yegber yir isekkilen" ],
      "Placeholder is missing the content property":[ "Amḍiq yettwaḥ€rzen ulac-it di tmeẓlit n ugbur" ],
      ...
      "A custom content_security_policy needs additional review.":[ "Aceggir-nniḍen ilaq ticki content_security_policy d udmawan." ],
      "The \"name\" property must be a string.":[ "Yessefk timeẓlit \"name\" ad tili d azrir n yisekkilen." ],
      ...
      "The \"version\" property must be a string.":[ "Talγut \"version\" isefk ad tili d aḍris." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Wali http://mzl.la/1kXIADa (MDN Docs) i wugar n telɣut." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Timeẓlit \"version\" tseqdac kan  masal n Firefox." ] } } }