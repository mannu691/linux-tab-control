module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Inline scripts blocked by default":[ "Scripts inline bloqueados por predefinição" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener chamado com o quarto argumento." ],
      ...
      "Content script defined in the manifest could not be found at \"%(path)s\".":[ "Script de conteúdo definido no manifesto não pôde ser encontrado em \"%(path)s\"." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Uma content_security_policy personalizada precisa de revisão adicional." ],
      "The \"name\" property must be a string.":[ "A propriedade \"nome\" tem de ser uma string." ],
      ...
      "The \"version\" property must be a string.":[ "A propriedade \"version\" tem de ser uma string." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Veja http://mzl.la/1kXIADa (MDN Docs) para mais informação." ],
      "The \"version\" property uses a Firefox-specific format.":[ "A propriedade \"version\" utiliza um formato específico do Firefox." ] } } }