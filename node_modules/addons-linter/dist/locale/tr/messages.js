module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener` truthy dördüncü argüman ile çağrıldı." ],
      ...
      "String name is reserved for a predefined message":[ "Dizge adı önceden tanımlanmış bir iletiye ayrılmış" ],
      ...
      "Translation string is missing the message property":[ "Çeviri dizgesinin message özelliği eksik" ],
      "No \"message\" message property is set for a string (https://mzl.la/2DSBTjA).":[ "Bir dizge için \"message\" mesaj özelliği ayarlanmadı (https://mzl.la/2DSBTjA)." ],
