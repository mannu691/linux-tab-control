module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "A custom content_security_policy needs additional review.":[ "Lypset shqyrtim shtesë për një content_security_policy vetjake." ],
      "The \"name\" property must be a string.":[ "Vetia \"name\" duhet të jetë një varg." ],
      ...
      "The \"version\" property must be a string.":[ "Vetia \"version\" duhet të jetë një varg." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Për më tepër të dhëna, shihni http://mzl.la/1kXIADa (Dokumentim te MDN)." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Vetia \"version\" përdor një format Firefox specifik." ] } } }